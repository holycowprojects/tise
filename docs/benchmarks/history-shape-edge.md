...
Generated by `analysis/history_shape.py` on 2026-08-26 15:43 India Standard Time.
...
| Measure | Value |
|---|---:|
| Visits (chosen navigations) | 5,706 |
...
Distribution on a log scale (5,705 gaps):
...
| per (category, session) @ 15.0m | 636 | 458 | 72.0% | 50 | 398 | **PASS** |
...
Visits in this database carrying a usable duration: **97.5%** (5,564 of 5,706). A zero duration means *not recorded*, which is an absence rather than a zero-second dwell, and is excluded from that share.
