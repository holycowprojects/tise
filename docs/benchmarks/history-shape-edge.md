...
| Measure | Value |
|---|---:|
| Visits (chosen navigations) | 5,734 |
| Chain interiors excluded | 209 |
...
Distribution on a log scale (5,733 gaps):
...
Visits in this database carrying a usable duration: **99.5%** (5,703 of 5,734). A zero duration means *not recorded*, which is an absence rather than a zero-second dwell, and is excluded from that share.
