...
Generated by `analysis/history_shape.py` on 2026-08-26 16:12 India Standard Time.
...
| Measure | Value |
|---|---:|
| Visits (chosen navigations) | 5,711 |
...
Distribution on a log scale (5,710 gaps):
...
| per (category, session) @ 60.0m | 468 | 290 | 62.0% | 37 | 292 | FAIL |
...
Visits in this database carrying a usable duration: **97.5%** (5,569 of 5,711). A zero duration means *not recorded*, which is an absence rather than a zero-second dwell, and is excluded from that share.
