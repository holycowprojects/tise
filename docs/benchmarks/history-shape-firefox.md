...
Source: local **Firefox** history database (`places.sqlite`), one person, timezone
...
**335** `return_24h` labels in 8 weeks, against a required
~300.
...
| Measure | Value |
|---|---:|
| Visits (chosen navigations) | 909 |
| Redirect hops excluded | 73 |
| History span | 38.1 days |
| Distinct registrable domains | 67 |
...
Distribution on a log scale (908 gaps):
...
|---:|---:|---:|---:|---:|---:|:--|
| 8 | 108 | 57 | 52.8% | 20 | 159 | FAIL |
| 15 | 116 | 57 | 49.1% | 21 | 170 | FAIL |
| 25 | 133 | 57 | 42.9% | 24 | 195 | FAIL |
...
|---|---:|---:|---:|---:|---:|:--|
| per (category, day) | 133 | 57 | 42.9% | 24 | 195 | FAIL |
| per (category, session) @ 15.0m | 228 | 138 | 60.5% | 42 | 335 | **PASS** |
| per (category, session) @ 30.0m | 204 | 114 | 55.9% | 37 | 300 | FAIL |
| per (category, session) @ 60.0m | 191 | 101 | 52.9% | 35 | 281 | FAIL |
| per (category, 3h window) | 203 | 113 | 55.7% | 37 | 298 | FAIL |
| per (category, 6h window) | 178 | 93 | 52.2% | 33 | 261 | FAIL |
| per (category, 12h window) | 152 | 70 | 46.1% | 28 | 223 | FAIL |
